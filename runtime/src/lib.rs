...
use sp_runtime::{
	...
	traits::{
		SaturatedConversion,StaticLookup,AccountIdLookup, BlakeTwo256, Block as BlockT, IdentifyAccount, NumberFor, One, Verify,AccountIdConversion,
	},
...
pub use frame_system::{EnsureSigned,EnsureRoot,EnsureSignedBy};
...
construct_runtime!(
	pub struct Runtime {
		...
		CollateralReaderModule: pallet_collateral_reader,
